...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.tovar.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('made_in', old('made_in'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('more_information', old('more_information'), array('class'=>'form-control')) !!}
