...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('manufacturer', old('manufacturer',$tovar->manufacturer), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('made_in', 'made_in', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('made_in', old('made_in',$tovar->made_in), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('size', 'size', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('size', old('size',$tovar->size), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('more_information', 'more_information', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('more_information', old('more_information',$tovar->more_information), array('class'=>'form-control')) !!}
